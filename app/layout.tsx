...
import "./globals.css";
import { Counter, NavLink, Route, CountersProvider } from "./components";
          ...
          <div className="w-full max-w-screen-sm flex-col flex">
            <div className="flex-col flex gap-2 min-h-72">
              <div className="w-fit gap-4 text-center flex mx-auto py-2">
                ...
                <NavLink href="/tab-d">Tab D (children)</NavLink>
              </div>
              ...
              >
                ...
                {/* <Counter2 label="Layout" id="root-layout" /> */}
                <Route path="/" component={children} />
                <Route path="/tab-c" component={children} />
                <Route path="/tab-d" component={children} />
            ...
            <div className="w-full [&_p]:mb-1">
              ...
              <ol className="list-decimal list-inside [&>li]:mb-2 mt-3 ml-2">
                <li>
                  Click on the tabs above to navigate between the different
                  routes
                </li>
                ...
                <li>
                  Notice that all counters (not just layout counters) continue
                  to increment even as you switch tabs
                </li>
                <li>
              ...
              <p>
                You will notice that Home and Tab C reset each other as you
                click back and forth between them. This is because they share
                the same slot, <code>children</code>. To truly have full
                tab-like behavior, each tab should have its own unique slot.
              </p>
              <p className="mt-2">
                Tab D is an example of a tab that does not have a slot, but
                still has access to the counters context. Because of context,
                even though it shares same slot as Tab C, and as Home, the
                counter still does not reset when switching between them.
              </p>
            </div>
